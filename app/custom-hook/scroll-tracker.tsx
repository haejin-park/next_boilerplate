'use client';
import { useAtBottom } from "./use-at-bootom";
...
export function ScrollTracker() {
    ...
    return (
        <div className="min-h-screen p-4 space-y-4 bg-gray-100">
            ...
            <p className="text-lg">
                {atBottom? "페이지 하단에 도달했습니다!" : "더 스크롤 하세요."}
            </p>
        </div>
    );
}
...
function Content() {
    ...
    const textToCopy = "클립보드에 복사할 텍스트 입니다.";
    const handleCopyClick = () => {copyToClipboard(textToCopy)};

    return (
        <div className="p-4 text-center text-gray-700 border border-gray-300">
            <p>{textToCopy}</p>
            <button 
